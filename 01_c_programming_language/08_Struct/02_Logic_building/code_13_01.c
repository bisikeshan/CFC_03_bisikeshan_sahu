 ...
 * @date: 26-03-2025 12:07 PM 
 */ 
 
 #include <stdio.h> // standard input-output library

 // structure definition for hospital
 struct Hospital
 {
 	 int hospId; // stores hospital Id
 	 char hospName[100]; // stores hospital name
 }; 
 ...
 int main()
 {
 	 // declare a structure variable to store patient details
    ...
    //display hospital, department, doctor, insurance and patient details
