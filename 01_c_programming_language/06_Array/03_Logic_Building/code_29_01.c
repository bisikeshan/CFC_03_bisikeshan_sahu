...
int main()
{
	...
	// array to store daily temperatures for a month 
	int days, le; 
	// numbers of days and loop variable

	float max_temp,min_temp; // variables to store hottest and coldest temperatures

	// promt user for members of days
    ...
    for(le = 0; le < days; le++)
    	...
    	// Initialize min and max with the first day's temperature
