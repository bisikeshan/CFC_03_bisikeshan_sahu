/* S.G.M.P 
 * @file: code_29_03.c
 * @brief: Analyze temperature data and find the hotest and coldest days
...
int main()
{
	...
	printf("Enter daily temperatures (in celsisum): \n"); 
	...
	// Initialize min and max with the first days temperatures
